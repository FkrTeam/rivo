...
export const heroSlides = [
  ...
  },
  {
    ...
    place: 'Hoboken',
    image: { name: '1404-willow-hoboken-02', alt: '1404 Willow Ave, Hoboken: amenity lounge with a wood ceiling' },
    focus: '50% 50%',
  },
  {
    ...
    title: '1404 Willow Ave',
    place: 'Hoboken',
    image: { name: '1404-willow-hoboken-06', alt: '1404 Willow Ave, Hoboken: corner elevation' },
    focus: '50% 40%',
  },
  {
    ...
    place: 'Hoboken',
    image: { name: '301-washington-hoboken-05', alt: '301 Washington St, Hoboken: street view along the storefronts' },
    focus: '50% 45%',
  },
  {
    ...
    title: '301 Washington St',
    place: 'Hoboken',
    image: { name: '301-washington-hoboken-02', alt: '301 Washington St, Hoboken: unit kitchen, white fronts with an oak tall run' },
    focus: '50% 50%',
  },
];
