...
export const projects = [
  {
    ...
    gallery: [
      ...
      { name: 'fiat-house-06', alt: 'Entrance lobby with a green wall' },
      { name: 'fiat-house-03', alt: 'Unit kitchen with island' },
      { name: 'fiat-house-05', alt: 'Unit kitchen, L-shaped' },
      { name: 'fiat-house-07', alt: 'Kitchen detail, integrated appliances' },
      { name: 'fiat-house-04', alt: 'Bedroom with built-ins and kitchen beyond' },
      { name: 'fiat-house-01', alt: 'Building exterior' },
    ],
  },
  {
    ...
    gallery: [
      ...
      { name: '1404-willow-hoboken-05', alt: 'Lath wall along the stair, lobby' },
      { name: '1404-willow-hoboken-01', alt: 'Wood-lined corridor with artwork' },
      { name: '1404-willow-hoboken-04', alt: 'Mail room: dark lacquer mailboxes in a timber-lined space' },
      { name: '1404-willow-hoboken-02', alt: 'Amenity lounge with a wood ceiling' },
      { name: '1404-willow-hoboken-03', alt: 'Lounge corridor, dark wall panels against timber' },
      { name: '1404-willow-hoboken-06', alt: 'Corner elevation' },
    ],
  },
  {
  ...
  },
  {
    ...
    featured: false,
    cover: 'double-tree-hilton-fort-lee-02',
    focus: '50% 50%',
    gallery: [
      { name: 'double-tree-hilton-fort-lee-02', alt: 'Reception desk and feature wall' },
      { name: 'double-tree-hilton-fort-lee-01', alt: 'Lobby stair and elevator lobby' },
      { name: 'double-tree-hilton-fort-lee-05', alt: 'Bar with a back-lit shelving wall' },
      { name: 'double-tree-hilton-fort-lee-04', alt: 'Restaurant with screens and wood ceiling' },
      { name: 'double-tree-hilton-fort-lee-06', alt: 'Boardroom with wall panels' },
      { name: 'double-tree-hilton-fort-lee-03', alt: 'Ballroom with full-height panels' },
    ],
  },
  {
    slug: 'hudson-cliff',
    ...
    featured: false,
    cover: 'hudson-cliff-07',
    focus: '50% 50%',
    gallery: [
      { name: 'hudson-cliff-07', alt: 'Lobby with reception desk and slatted ceiling' },
      { name: 'hudson-cliff-05', alt: 'Lobby lounge' },
      { name: 'hudson-cliff-06', alt: 'Lounge seating with wood wall panels' },
      { name: 'hudson-cliff-01', alt: 'Unit kitchen with island' },
      { name: 'hudson-cliff-02', alt: 'Bathroom vanity with integrated lighting' },
  ...
  },
  {
    ...
    focus: '50% 50%',
    gallery: [
      { name: 'dallas-townhomes-01', alt: 'Black high-gloss kitchen with island' },
      { name: 'dallas-townhomes-04', alt: 'Kitchen island in black stone' },
      { name: 'dallas-townhomes-03', alt: 'Kitchen, view along the island' },
      { name: 'dallas-townhomes-02', alt: 'Bathroom with an oak vanity' },
  ...
  },
  {
    ...
    gallery: [
      ...
      { name: 'cibo-vita-office-02', alt: 'Meeting alcove in oak' },
